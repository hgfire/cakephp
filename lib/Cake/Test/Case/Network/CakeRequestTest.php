 ...
 */
	public function testBaseUrlWithNoModRewrite() {
		$_SERVER['DOCUMENT_ROOT'] = '/Students/markstory/Sites';
		$_SERVER['SCRIPT_FILENAME'] = '/Students/markstory/Sites/cake/index.php';
 ...
 */
	public function testBaseUrlNoRewriteTopLevelIndex() {
		...
		$_SERVER['DOCUMENT_ROOT'] = '/Students/markstory/Sites/cake_dev';
		$_SERVER['SCRIPT_FILENAME'] = '/Students/markstory/Sites/cake_dev/index.php';
 ...
 */
	public function testBaseUrlWithAppAndWebrootInDirname() {
		...
		$_SERVER['DOCUMENT_ROOT'] = '/Students/markstory/Sites/';
		$_SERVER['SCRIPT_FILENAME'] = '/Students/markstory/Sites/approval/index.php';
		...
		$_SERVER['DOCUMENT_ROOT'] = '/Students/markstory/Sites/';
		$_SERVER['SCRIPT_FILENAME'] = '/Students/markstory/Sites/webrootable/index.php';
 ...
 */
	public function testBaseUrlNoRewriteWebrootIndex() {
		Configure::write('App.baseUrl', '/index.php');
		$_SERVER['DOCUMENT_ROOT'] = '/Students/markstory/Sites/cake_dev/app/webroot';
		$_SERVER['SCRIPT_FILENAME'] = '/Students/markstory/Sites/cake_dev/app/webroot/index.php';
